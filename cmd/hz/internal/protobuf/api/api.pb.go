...
var (
	...
	E_GenPath = &file_api_proto_extTypes[18] // The path specified by the user when the client code is generated, with a higher priority than api_version
	// optional string api_version = 50302;
	E_ApiVersion = &file_api_proto_extTypes[19] // Specify the value of the :version variable in path when the client code is generated
	// optional string tag = 50303;
	E_Tag = &file_api_proto_extTypes[20] // rpc tag, can be multiple, separated by commas
	// optional string name = 50304;
	E_Name = &file_api_proto_extTypes[21] // Name of rpc
	// optional string api_level = 50305;
	E_ApiLevel = &file_api_proto_extTypes[22] // Interface Level
	// optional string serializer = 50306;
	E_Serializer = &file_api_proto_extTypes[23] // Serialization method
