...
var (
	...
	serviceClientName       = "client.go"       // client of service for quick call
...
`,
		...
		{
			Path:   defaultRouterDir + sp + serviceClientName,
			Delims: [2]string{"{{", "}}"},
			Body:   serviceClientTpl,
		},
	},
}
...
var serviceClientTpl = `// Code generated by hertz generator.
